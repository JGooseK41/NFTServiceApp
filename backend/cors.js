...
function configureCORS(app) {
  ...
  app.options('*', (req, res) => {
    ...
    if (origin === 'null' || allowedOrigins.includes(origin) || !origin) {
      ...
      res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Requested-With, X-Server-Address, X-Admin-Address, X-Wallet-Address, X-Recipient-Address, X-Timezone, X-Wallet-Provider, X-Visitor-Id, X-Fingerprint, X-Fingerprint-Confidence');
